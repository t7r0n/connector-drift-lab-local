...
This is a local prototype, not a production integration with Fivetran. A production version would need authentication, tenant isolation, rate limits, formal privacy review, logging policy, and validation against private ground truth.
