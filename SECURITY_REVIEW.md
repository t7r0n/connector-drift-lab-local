...
- Local CLI and JSONL tool loop for `connectorforge`.
...
This is a local prototype, not a production connector-platform integration. A production version would need authentication, tenant isolation, rate limits, formal privacy review, logging policy, and validation against private ground truth.
