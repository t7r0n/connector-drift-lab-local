...
from connector_drift_lab_local.engine import (
    LocalHarness,
    benchmark,
    export_demo_pack,
    jsonl_loop,
...
from connector_drift_lab_local.fixtures import init_store, load_config, load_scenarios
...
def test_benchmark_and_cli_smoke():
    result = subprocess.run(
        [sys.executable, "-m", "connector_drift_lab_local.cli", "init-demo", "--force"],
        check=True,
        capture_output=True,
        text=True,
    )
